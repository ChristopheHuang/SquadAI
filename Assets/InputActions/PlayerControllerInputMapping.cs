...
public partial class @PlayerControllerInputMapping: IInputActionCollection2, IDisposable
{
    ...
    ~@PlayerControllerInputMapping()
    {
        UnityEngine.Debug.Assert(!m_PlayerKeyBoard.enabled, "This will cause a leak and performance issues, PlayerControllerInputMapping.PlayerKeyBoard.Disable() has not been called.");
    }
